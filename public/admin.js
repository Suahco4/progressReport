...
function getDefaultPeriods() {
    return [
        { id: 'p1', name: '1st Period', type: 'period' }, { id: 'p2', name: '2nd Period', type: 'period' }, { id: 'p3', name: '3rd Period', type: 'period' }, { id: 'exam1', name: 'Exam 1', type: 'exam' }, { id: 'p4', name: '4th Period', type: 'period' }, { id: 'p5', name: '5th Period', type: 'period' }, { id: 'p6', name: '6th Period', type: 'period' }, { id: 'exam2', name: 'Exam 2', type: 'exam' }
    ];
}
